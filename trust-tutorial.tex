...
\frame{\frametitle{What Should Appraisal Say?}
...
\frame{\frametitle{What The Appraiser Knows}
  ...
  \item On initial measurement after startup
    \begin{itemize}
    \item \texttt{SENTER} and \texttt{SINIT} ran
    \item \texttt{SINIT} measured the MLE
    \item MLE was correct on startup
    \end{itemize}
  \item On measurement after application startup
    \begin{itemize}
    \item OS was correct on startup and was started by MLE
    \item Application was correct on startup and was started by OS
    \end{itemize}
  \end{itemize}
